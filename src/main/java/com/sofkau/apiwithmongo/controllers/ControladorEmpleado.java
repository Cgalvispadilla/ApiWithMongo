package com.sofkau.apiwithmongo.controllers;

import com.sofkau.apiwithmongo.dtos.EmpleadoDTO;
import com.sofkau.apiwithmongo.services.ServicioEmpleado;
...
public class ControladorEmpleado {
    ...
    public ResponseEntity<EmpleadoDTO> findbyId(@PathVariable("id") String id) {
        ResponseEntity responseEntity = new ResponseEntity(servicioEmpleado.obtenerPorId(id), HttpStatus.OK);
